...
using GameReviews.Models;   /// This particular line of code gets the custom created "data" in "ClassReviews" to utilize the "models" folder.
...
namespace GameReviews.Data
{
    public class GameRepository
    {
        ...
        public GameReview[] GetGames()  //Defines a method which.... accepts an array? or it is an array?
        {
